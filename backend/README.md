...
The backend provides first-party API endpoints for authentication, profile-backed users, wellness content, therapist discovery, appointment booking, bookmarks, mood tracking, and support requests.
